...
var completer = readline.NewPrefixCompleter(
	...
	readline.PcItem("feature_get -n",
		readline.PcItem("breakpoint_details"),
		readline.PcItem("breakpoint_include_return_value"),
	...
	readline.PcItem("feature_set -n",
		readline.PcItem("breakpoint_details -v"),
		readline.PcItem("breakpoint_include_return_value -v"),
